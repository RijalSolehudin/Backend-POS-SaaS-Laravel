...
| P08-02 | [QR Self-Order Session](P08-02-qr-self-order-session.md) | P08-01, Dining | Implemented — Pending MariaDB Verification |
| P08-03 | [Customer Cart and Staff Confirmation](P08-03-customer-cart-staff-confirmation.md) | P08-02, Sales | Implemented — Pending MariaDB Verification |
| P08-04 | [Waiter Workflow](P08-04-waiter-workflow.md) | P08-03, Dining | Implemented — Pending MariaDB Verification |
| P08-05 | [Payment Gateway Abstraction](P08-05-payment-gateway-abstraction.md) | P08-03, Sales | Implemented — Pending MariaDB Verification |
| P08-06 | [Reservation Minimum](P08-06-reservation-minimum.md) | P08-02, Dining | Implemented — Pending MariaDB Verification |
| P08-07 | [Promotion Discount MVP](P08-07-promotion-discount-mvp.md) | P08-03, Sales | Implemented — Pending MariaDB Verification |
| P08-08 | [Analytics Export and Growth Readiness](P08-08-analytics-export-growth-readiness.md) | P08-02..P08-07 | Implemented — Pending MariaDB Verification |
