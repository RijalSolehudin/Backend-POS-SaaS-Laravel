...
final readonly class ListAvailableOutletCatalog
{
    ...
    {
        /** @var list<object{id: string, sku: string, name: string, category_id: string, category_name: string, base_price_minor: int, outlet_price_minor: int|null, currency: string}> $rows */
        $rows = Product::query()
