...
final readonly class UpdateProductVariant
{
    ...
    public function handle(TenantRequestContext $context, string $variantId, ProductVariantInput $input): ProductVariant
    {
        $this->permissions->authorizeManageCatalog($context);

        return DB::transaction(function () use ($context, $variantId, $input): ProductVariant {
            ...
            $this->ensureSkuAvailable($context, $variant->id, $sku);
    ...
    private function ensureSkuAvailable(TenantRequestContext $context, string $variantId, string $sku): void
    {
