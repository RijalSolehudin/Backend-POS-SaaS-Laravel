...
Route::prefix('api/v1')
    ...
    ->group(function (): void {
        Route::middleware(['auth:sanctum', 'api.tenant-user-active'])->group(function (): void {
            ...
            Route::post('pos/outlets/{outlet}/shifts/{shift}/cash-movements', [ShiftController::class, 'cashMovement'])
                ->where([
                    'outlet' => '[0-9a-hjkmnp-tv-z]{26}',
                    'shift' => '[0-9a-hjkmnp-tv-z]{26}',
                ])
                ->name('pos.outlets.shifts.cash-movements.store');
            ...
            Route::post('pos/outlets/{outlet}/orders/{order}/refund', [OrderController::class, 'refund'])
                ->where([
                    'outlet' => '[0-9a-hjkmnp-tv-z]{26}',
                    'order' => '[0-9a-hjkmnp-tv-z]{26}',
                ])
                ->name('pos.outlets.orders.refund');
