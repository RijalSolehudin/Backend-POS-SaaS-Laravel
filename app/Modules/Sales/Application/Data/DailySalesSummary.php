...
{
    /**
     * @param  list<array{outlet_id: string, outlet_name: string, completed_orders_count: int, gross_sales_minor: int, recorded_payments_minor: int, cash_payments_minor: int, manual_non_cash_payments_minor: int}>  $outlets
     */
