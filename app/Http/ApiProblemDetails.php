...
final class ApiProblemDetails
{
    ...
    private function businessStatus(BusinessException $exception): int
    {
        return match ($exception->errorCode()) {
            ...
            'OUTLET_NOT_FOUND', 'POS_DEVICE_NOT_FOUND', 'DEVICE_NOT_REGISTERED', 'SHIFT_NOT_FOUND', 'ORDER_NOT_FOUND', 'ORDER_ITEM_NOT_FOUND', 'ORDER_PRODUCT_UNAVAILABLE', 'RECEIPT_NOT_FOUND' => 404,
            'SHIFT_ALREADY_OPEN', 'SHIFT_NOT_OPEN', 'ORDER_ACTIVE_SHIFT_REQUIRED', 'ORDER_NOT_DRAFT', 'ORDER_NOT_COMPLETED', 'ORDER_ITEMS_REQUIRED', 'IDEMPOTENCY_CONFLICT' => 409,
            'ORDER_REASON_REQUIRED' => 422,
